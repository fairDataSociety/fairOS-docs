...
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.8.2-rc2/dfs-linux-amd64
...
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.8.2-rc2/dfs-cli-linux-amd64
...
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.8.2-rc2/dfs-darwin-amd64
...
In another terminal, run the dfs-cli to connect and test it
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.8.2-rc2/dfs-cli-darwin-amd64
