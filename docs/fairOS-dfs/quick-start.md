...
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.9.0-rc1/dfs-linux-amd64
...
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.9.0-rc1/dfs-cli-linux-amd64
...
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.9.0-rc1/dfs-darwin-amd64
...
In another terminal, run the dfs-cli to connect and test it
```sh
wget https://github.com/fairDataSociety/fairOS-dfs/releases/download/v0.9.0-rc1/dfs-cli-darwin-amd64
